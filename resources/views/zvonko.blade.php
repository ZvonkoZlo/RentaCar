...
<body class="font-sans antialiased">
    ...
    <div class="p-6 text-gray-900">
        {{ __("You're logged in!") }}
        <p>Ovo je use case diagram</p>
        <img src="{!! asset('/images/usecase.jpg') !!}" alt="usercase" title="" width="800" height="800" />

        @if (Auth::user()->isAdmin())
            <div>
                <h1>Lista za odraditi</h1>
                <form method="post" action="{{ route('saveItem') }}" accept-charset="UTF-8">
                    {{ csrf_field() }}
                    <label for="listItem">Nova lista</label><br>
                    <input type="text" name="ime">
                    <button style="background-color: black color:antiquewhite">Posalji</button>
                </form>
            </div>
        @else
            <p>Vi niste admin i ne mozete viditi ostali sadrzaj,<a href="/load">Vratite se na pocetnu stranicu</a></p>
        @endif
