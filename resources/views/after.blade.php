...
<header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
  <div class="w3-display-left w3-text-white" style="padding:48px">
    ...
    <p><a href="{{  route('products.index')  }}" class="w3-button w3-white w3-padding-large w3-large w3-margin-top w3-opacity w3-hover-opacity-off">Rezerviraj vozilo jos danas</a></p>
  </div> 
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        ...
        <h3>Veselko Coric</h3>
         ...
         <a href="{{ route('kontakt') }}" ><p><button class="w3-button w3-light-grey w3-block"><i class="fa fa-envelope"></i> Contact</button></p></a>
        </div>
      </div>
    </div>
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        ...
        <h3>Zvonko Zlopasa</h3>
          ...
          <a href="{{ route('kontakt1') }}" ><p><button class="w3-button w3-light-grey w3-block" ><i class="fa fa-envelope"></i> Contact</button></p></a>
        </div>
      </div>
    </div>
