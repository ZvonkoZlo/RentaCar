...
<body>
    ...
    <nav class="w3-sidebar w3-bar-block w3-black w3-card w3-animate-left w3-hide-medium w3-hide-large"
        ...
        <a href="{{ route('products.index') }}" onclick="w3_close()" class="w3-bar-item w3-button">Ponuda
            automobila</a>
    ...
    <header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
        <div class="w3-display-left w3-text-white" style="padding:48px">
            ...
            <p><a href="{{ route('login') }}"
                    class="w3-button w3-white w3-padding-large w3-large w3-margin-top w3-opacity w3-hover-opacity-off">Rezerviraj
                    vozilo jos danas</a></p>
        </div>
    ...
    <div class="w3-container" style="padding:128px 16px" id="about">
        ...
        <div class="w3-row-padding w3-center" style="margin-top:64px">
            ...
            <div class="w3-quarter">
                ...
                <p>Naša korisnička Podrška je za vas dostupna 24H svaki dan.Možete nas kontaktirati na broj 0800 88 888.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="w3-container" style="padding:128px 16px" id="team">
        ...
        <div class="w3-row-padding w3-grayscale" style="margin-top:64px">
            ...
            <div class="w3-col l3 m6 w3-margin-bottom">
                <div class="w3-card">
                    <img src="https://img.freepik.com/free-vector/professional-car-rental-logo_23-2149509962.jpg?w=740&t=st=1675759604~exp=1675760204~hmac=82c0b279cc29b21338de130f7dac37e71a016f93f55c3c092f3e8fa55ab884c0"
                        alt="Zvone" style="width:100%">
                    <div class="w3-container">
                        <h3>Veselko Coric</h3>
                        <p class="w3-opacity">Clan Tima
                        <p>Student trece godine studija Racunarstva na Fakultetu Strojarstva,Racunarstva,Elektrotehnike
                            u Mostaru.
    ...
    < <!-- Image of location/map -->
        ...
        <footer class="w3-center w3-black w3-padding-64">
            <a href="#home" class="w3-button w3-light-grey"><i class="fa fa-arrow-up w3-margin-right"></i>Vrati na
                vrh</a>
