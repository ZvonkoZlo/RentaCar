...
<head>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    ...
    <title>Dodaj vozilo - Car Rental Services</title>
                ...
                <div class="w-full px-4 py-6 ">
                    ...
                    <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-1">
                            ...
                            <input type="number" name="price" min="1" class="h-12 px-3 w-full border-blue-400 border-2 rounded focus:outline-none focus:border-blue-600">
                           </div>
                        ...
                        <div class="mt-3 text-right">
                            ...
                            <button  type="submit" class="ml-2 h-10 w-32 bg-blue-600 rounded text-white hover:bg-blue-700">Dodaj proizvod</button>
