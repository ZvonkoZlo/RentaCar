  ...
  <div class="w3-bar w3-black w3-card" id="myNavbar">
    ...
    <main class="container my-5">
        ...
        <div class="row">
          ...
          <div class="card">
            <img src="https://cdn.dicklovett.co.uk/uploads/used_stock_image/1_914170_sl.jpg?v=1663248094" class="card-img-top" alt="Compact Car">
            <div class="card-body">
              ...
              <input type = 'submit' class="w3-button w3-black" value = "Ažuriraj" />
              <input type = 'submit' class="w3-button w3-black" value = "Izbriši" />
              @endif
            </div>
          </div>
        </div> --}}
         ...
         @foreach ($products as $category)
            ...
            <div class="col-md-4">
              ...
              <div class="card">
               <img src="{{ Storage::url($category->image) }}" class="card-img-top" alt="SUV">
               <div class="card-body">
             <h5 class="card-title">{{ $category->name }}</h5>
             <p class="card-text">Nova vozila</p>
             @if (Auth::user()->isSuperAdmin() or Auth::user()->isAdmin())
             <input type = 'submit' class="w3-button w3-black" value = "Ažuriraj" />
             <input type = 'submit' class="w3-button w3-black " value = "Izbriši" />
             @endif
           ...
           @endforeach
            ...
            @foreach ($products as $category)
                <div class="col-md-4 mb-3">
                    ...
                    <div class="card" style="background-color: rgba(149, 145, 145, 0.1); box-shadow: 2px 2px rgba(189, 186, 186, 0.1);">
                        <img src="{{ Storage::url($category->image) }}" class="card-img-top img-fluid"
                            ...
                            @if(auth()->check())  <a href="/cart" class="text-decoration-none ">  @endif<div class="card-footer background-color-black  rounded text-center text-strong promijeni">
