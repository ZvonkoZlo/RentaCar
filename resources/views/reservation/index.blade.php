                                ...
                                @if (Auth::user()->isAdmin() or Auth::user()->isSuperAdmin())
                                    <td>
                                        ...
                                        <div class="d-flex justify-content-center">
                                            <a href="{{ route('potvrdi', $rezervacija->id) }}"><button
                                                    class="btn btn-primary m-1 btn-sm">Potvrdi Narudzbu</button></a>
                                            <a href="{{ route('odbij', $rezervacija->id) }}"><button
                                                    class="btn btn-danger m-1 btn-sm">Odbij Narudzbu</button></a>
                                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href=""><button class="btn btn-primary"><input type="submit" class="btn btn-danger"
                                value="Izbriši"></a>
                </div>
