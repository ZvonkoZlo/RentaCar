...
<div class="w3-container w3-light-grey" style="padding:128px 16px" id="contact">
  ...
  <div style="margin-top:48px">
    <p><i class="fa fa-map-marker fa-fw w3-xxlarge w3-margin-right"></i> Mostar,BiH</p>
    <p><i class="fa fa-phone fa-fw w3-xxlarge w3-margin-right"></i> Telefon:063-518-008</p>
    <p><i class="fa fa-envelope fa-fw w3-xxlarge w3-margin-right"> </i> Email:veselko.coric@fsre.sum.ba</p>
    <br>
    <form action="https://formspree.io/f/xbjegjgq" method="POST">
