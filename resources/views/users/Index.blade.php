                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <a href="#deleteEmployeeModal" class="btn btn-danger" data-toggle="modal"><i
                                    class="material-icons">&#xE15C;</i> <span>Izbriši</span></a>
                        </div>
                    </div>
                </div>
                @if (Auth::user()->isSuperAdmin())
                        ...
                        <tbody>
                            ...
                            @foreach ($korisnik as $korisnik)
                                <tr>
                                    ...
                                    <td>
                                        @if ($korisnik->is_admin == 2)
                                            Superadmin
                                        @elseif($korisnik->is_admin == 1)
                                            Admin
                                        @else
                                            (korisnik->is_admin==0)
                                            Korisnik
                                    ...
                                    <td>
                                        <a href="{{ route('users.edit', $korisnik->id) }}" class="edit"><i
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="delete/{{ $korisnik->id }}"><button class="btn btn-primary"><input type="submit"
                                class="btn btn-danger" value="Izbriši"></a>
                </div>
