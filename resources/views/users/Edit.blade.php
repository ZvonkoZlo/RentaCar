            ...
            <div class="modal-content">
                <form action="{{ route('users.update', $korisnik->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-header">						
						...
						<a href="{{ route('korisnici') }}"> <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button></a>
                    </div>
                        ...
                        <div class="form-group">
							...
							<div class="wrapper">
								<div class="toggle_radio">
								  ...
								  <input type="radio" checked class="toggle_option" id="second_toggle" name="uloga" value="1">
								  <input type="radio" class="toggle_option" id="third_toggle" name="uloga" value="0">
								  <label for="first_toggle"><h6>Super Admin</h6></label>
								  <label for="second_toggle"><h6>Admin</h6></label>
								  <label for="third_toggle"><h6>Korisnik</h6></label>
                    ...
                    <div class="modal-footer">
                        <a href="{{ route('korisnici') }}"><input type="button" class="btn btn-default"  value="Odustani"></a>
                        <button type="submit"
